...
/* ----------------- METHODS ----------------- */
RANGINE_INLINE SDL_Window *rg_init(const u32, const u32);
...
RANGINE_INLINE SDL_Window *rg_init(const u32 width, const u32 height) {
    SDL_Window *m_window = rg_init_window("GAME", width, height);
